 ...
 * {@link #writeSample(int)} method to do whather processing is needed before
 * actually writing the sample.
 *
 * @author Gerrit Meinders
 */
public abstract class FilterAudioOutputStream extends FilterOutputStream
{
	/**
	 ...
	 */
	public FilterAudioOutputStream(OutputStream out, AudioFormat format)
	{
		super(out);
	 ...
	 * @throws IllegalArgumentException if the specified format isn't supported.
	 */
	private SampleFormat getSampleFormat(AudioFormat format)
	{
	...
	protected interface SampleFormat
	{
		 ...
		 *             sample format.
		 */
		void write(OutputStream out, int sample) throws IOException;
	 ...
	 *
		 * @author Gerrit Meinders
	 */
	private abstract static class PCM16 implements SampleFormat
	{
	 ...
	 *
		 * @author Gerrit Meinders
	 */
	private static class PCM16LE extends PCM16
	{
		@Override
		...
		@Override
		public void write(OutputStream out, int sample) throws IOException
		{
	 ...
	 *
		 * @author Gerrit Meinders
	 */
	private static class PCM16BE extends PCM16
	{
		@Override
		public boolean update(int b)
		{
	 ...
	 *
		 * @author Gerrit Meinders
	 */
	private static class PCM8 implements SampleFormat
	{
		private int buffer;
	...
	/**
	 * Writes state information about the object to the given log.
	 *
	 * @param log Log to write to.
	 */
	protected void writeState(Log log)
	{
		log.writeDetails("sampleFormat", sampleFormat);
	}
}
