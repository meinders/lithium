...
public class WaveOutputStream extends FilterOutputStream {
	private final AudioFormat format;

	private boolean headerWritten;

	public WaveOutputStream(OutputStream out, AudioFormat format) {
		super(out);
		this.format = format;
	}
	...
	private static void writeShortLE(OutputStream out, int s)
	        throws IOException {
		out.write(s);
		out.write(s >> 8);
	}
